...
class ExtensionTypeWarning : public layer_factory {
   public:
    ...
    VkResult VKAPI_CALL PreCallCreateInstance(const VkInstanceCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator,
    ...
    VkResult VKAPI_CALL PostCallCreateDevice(VkPhysicalDevice physicalDevice, const VkDeviceCreateInfo* pCreateInfo,
